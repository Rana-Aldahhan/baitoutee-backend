...
@section('content')
    ...
    <div class="row">
        ...
        <div class="">
            ...
            <!--table-->
            <table id="table" class="bg-white table table-striped table-hover nowrap rounded shadow-xs border-xs mt-2"
                ...
                <tbody>
                    @foreach ($orders as $order)
                        <tr id="order_{{ $order->id }}">
                            ...
                            <td>{{ $order->profit }} </td>
                            <td>
                                <a href="#" class="btn btn-xs btn-success m-1" onclick="approve({{ $order->id }})">
                                    قبول
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                ...
                                <a href="#" class="btn btn-xs btn-danger m-1" onclick="reject({{ $order->id }})">
                                    رفض
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
