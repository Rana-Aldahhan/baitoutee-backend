...
class OrderController extends Controller
{
     ...
     */
    public function indexForChefOrderedMeals(Request $request)
    {
        // get the meals of orders in a specific hour
        // chef id = id and time of the order = this hour + 1 ... until finish the time of deliver
        $chefId = auth('chef')->id();
        $chefOrders = $chefId = auth('chef')->user()->orders();
        dd($chefOrders);
